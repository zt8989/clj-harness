(ns harness.cap.preamble
  ...
  harness.infra.home/root -- see harness.infra.home/user-home for why those are two
  different floors."
...
(defn gather
  ...
  The contrast with harness.cap.skills is the point of the split rather than an
