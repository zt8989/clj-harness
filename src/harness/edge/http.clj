...
(def ^:private thread-verbs
  ...
  SEVEN OF THE NINE ARE GETS: `stats`, `trajectory` and `delegations` only READ the log (a folded
  ...
  #{"rebuild" "archive" "stats" "trajectory" "sofar" "feed" "page" "delegations" "follow"})
