...
//
// `lib/session-status.ts` holds the sentences, because the row and the project
// menu both show them and two wordings of one rule drift.
...
export const Sidebar: FC<SidebarProps> = ({
  ...
  const archive = async (
    ...
    if (blocked(status)) {
      refuse(threadId, archiveRefusal(status));
      return;
    }
